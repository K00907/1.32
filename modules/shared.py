...
parser.add_argument("--prepare-env-only", action='store_true', help="only prepare the environment, download necessary files, without actually start the application", default=False)
